...
function BigStat({ value, label, emoji, color }) {
  return (
    <div style={{ background: 'var(--glass-bg)', backdropFilter: 'var(--glass-blur)', WebkitBackdropFilter: 'var(--glass-blur)', borderRadius: 14, padding: '16px', boxShadow: '0 2px 10px rgba(0,0,0,0.06)' }}>
