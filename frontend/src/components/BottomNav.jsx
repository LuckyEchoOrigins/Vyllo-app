...
export default function BottomNav({ activeTab, onTabChange }) {
  ...
  return (
    <nav style={{
      ...
      right: 0,
      width: '100%',
      // 54px de conteúdo (perto de uma tab bar nativa) + só a safe-area do
      // indicador home. Antes eram 64px, o que deixava folga a mais em baixo.
      height: 'calc(54px + max(6px, env(safe-area-inset-bottom)))',
