...
export default function ItemDetail({ item, onClose, onUpdate, onDelete, user }) {
  ...
  return (
    <div className="overlay-full" style={{ animation: 'slideUp 0.3s cubic-bezier(.22,1,.36,1) both', margin: 0, padding: 0 }}>
      ...
      <div style={{ position: 'absolute', top: '-200px', left: 0, right: 0, bottom: 0, zIndex: 0, overflow: 'hidden' }} aria-hidden>
        {hasBlurBg ? (
          <img
            src={item.cover}
